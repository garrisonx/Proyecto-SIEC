    ...
    <body>
        ...
        <%
                ...
                try {
                    ...
                    conection=DriverManager.getConnection("jdbc:mysql://localhost:8889/siec", "root","root");
                int competenciaId = request.getParameter("competenciaId")==null?0:Integer.parseInt(request.getParameter("competenciaId").toString());
                ...
                String path = "/Users/Garrison/Proyectos/Proyecto-SIEC/web/Reporte de competencias"; // ruta donde esta el jasper dentro de tu proyecto
