...
INSERT INTO `tr_evaluacion_parcial` (`EVALUACION_PARCIAL_ID`, `CALIFICACION`, `PARCIAL`, `EVALUACION_NIVEL_ID`, `TIPO_EVALUACION_ID`, `MAESTRO_MATERIA_GRUPO_SESION_ID`, `ALUMNOS_ID`) VALUES
(2, 9, 9, 1, 1, 1, 2),
(3, 10, 2, 2, 2, 2, 3),
(7, 8, 2, 3, 3, 3, 2),
(9, 7, 3, 2, 2, 4, 6);
...
INSERT INTO `tr_sesion` (`MAESTRO_MATERIA_GRUPO_SESION_ID`, `PRESESION_ID`, `MAE_MAT_GRP_ID`) VALUES
(1, 1, 1),
(2, 2, 2),
(3, 3, 3),
(4, 4, 4);
...
ALTER TABLE `tr_evaluacion_parcial`
  ...
  ADD CONSTRAINT `fk_TR_EVALUACION_PARCIAL_TR_MAESTRO_MATERIA_GRUPO_SESION1` FOREIGN KEY (`MAESTRO_MATERIA_GRUPO_SESION_ID`) REFERENCES `tr_maestro_materia_grupo_sesion` (`MAESTRO_MATERIA_GRUPO_SESION_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `tr_presesion_rechazada`
  ADD CONSTRAINT `fk_tr_presesion` FOREIGN KEY (`PRESESION_ID`) REFERENCES `tr_presesion` (`SESION_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `tr_sesion`
--
ALTER TABLE `tr_sesion`
  ADD CONSTRAINT `fk_TR_MAESTRO_MATERIA_GRUPO_SESION_TR_SESION1` FOREIGN KEY (`PRESESION_ID`) REFERENCES `tr_presesion` (`SESION_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
